...
if(!require("igraph")){install.packages("RColorBrewer",repos="http://cran.rstudio.com")}
if(!require("diagram")){install.packages("RColorBrewer",repos="http://cran.rstudio.com")}
if(!require("binom")){install.packages("RColorBrewer",repos="http://cran.rstudio.com")}
