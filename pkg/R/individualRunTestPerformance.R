individualRunTestPerformance<-function(batchMSlocation="../batchMS.R",compareLocation="../comparecladespipe.pl",msLocation="/home/bomeara/bin/ms",popVector=c(3,4,4),maxK=2,itnmax=40,nTrees=1000000,migrationArray=NULL,migrationArrayMap=NULL, trueModelID=5,trueModelParams=c(0.9,0.2),nTreesObserved=3) {
  ...
  print(result)
  save(result,file="testRunResult.Rsave",compress=TRUE)
}